...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-500 underline">Home</a>
            @else
...
{{--        <div class="title m-b-md" style="color: #e2e8f0">--}}
{{--            @isset($users)--}}
{{--                <h2></h2>--}}
{{--                <table class="justify-center text-center ml-12 ">--}}
{{--                    <tr>--}}
